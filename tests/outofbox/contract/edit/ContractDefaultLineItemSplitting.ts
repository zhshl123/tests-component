...
import { checkMessagePopupBox, clickButton, clickFirstSingleCheckBox, clickSectionButton, waitMessagePopupBoxInvisible } from '../../common';
import { browseContract } from '../components';
import { contractDefaultLineItemSplittingAttributesMap } from '../components/ContractDefaultLineItemSplittingAttributes';

export const addContractDefaultLineItemSplitting = {
...
export class ContractDefaultLineItemSplitting {
    sectionPanel = () =>
