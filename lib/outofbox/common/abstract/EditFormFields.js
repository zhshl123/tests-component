...
class EditFromFields {
    constructor(entityMap) {
        ...
        */
         ...
         * @returns
         */
        this.checkSelectedSingleCheckbox = (fieldName, nth) => {
            return core_1.Task.where(`#actor check selected ${nth} single checkbox ${fieldName} `, assertions_1.Ensure.eventually(web_1.Attribute.called('checked').of(this.radioButtonInput(fieldName, nth)), (0, assertions_1.equals)('checked')));
        };
        /**
        ...
        */
        ...
        this.selectNAICSItemInlookupPopup = (fieldName, itemName, popupFieldName) => {
            core_1.Task.where(`#actor searchs single item : ${itemName} in ${fieldName} lookup popup`, web_1.Click.on(this.lookupIcon(fieldName)), 
            // 确保弹窗有显示再进行下一步搜索操作
        ...
        */
         ...
         * @returns
         */
        this.ralationshipAttributeLookupDropdownItem = (fieldName, itemName) => web_1.PageElement.located(web_1.By.css(`[title="${itemName}"]`))
