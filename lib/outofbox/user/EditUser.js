...
class EditUser extends abstract_1.EditFromFields {
    constructor(entityMap) {
         ...
         * @returns
         */
        this.userRoleRadioButtonLebel = (itemNth) => {
            return web_1.PageElement.located(web_1.By.css(`[for="ctl00_body_UserRole_rdoRoles_${itemNth}"]`))
         ...
         * @returns
         */
        this.userRoleRadioButtonInput = (itemNth) => {
            return web_1.PageElement.located(web_1.By.id(`ctl00_body_UserRole_rdoRoles_${itemNth}`))
