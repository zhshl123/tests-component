...
exports.deleteMultiInvoiceLineItems = exports.updateMultiInvoiceLineItem = exports.checkInvoiceLineItems = exports.addMultiInvoiceLineItems = exports.loadLineItem = void 0;
...
exports.loadLineItem = {
    using: (invoiceLineItemInfo) => {
        ...
        // 遍历数组，循环更新数据
        items.forEach(({ actor, item }) => actor.attemptsTo(InvoiceLineitemFields_1.invoiceLineitem.selectContractLineItemInPopup(item.SOVItem))), common_1.clickButton.using(DefaultStaticParams_1.SAVE), (0, common_1.checkMessagePopupBox)(), (0, common_1.waitPageSaveLodingLayerInvisible)());
    }
};
/**
