...
exports.checkSA = {
    using: (SAInfo) => {
        return core_1.Task.where(`#actor check fields`, assertions_1.Ensure.eventually(web_1.Text.of(EditSA_1.SA.lookupInputFieldSingleValue('Primary Project')), (0, assertions_1.includes)(SAInfo.rowsHash().PrimaryProject)), assertions_1.Ensure.eventually(web_1.Text.of(EditSA_1.SA.lookupInputFieldSingleValue('Primary Contract')), (0, assertions_1.includes)(SAInfo.rowsHash().PrimaryContract)), EditSA_1.SA.checkTextInputFieldValue('Title', SAInfo.rowsHash().Title, DefaultStaticParams_1.SUCCEEDED), EditSA_1.SA.checkDateInputFieldValue('Date Reported', SAInfo.rowsHash().DateReported, DefaultStaticParams_1.SUCCEEDED));
    }
};
