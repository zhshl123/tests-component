...
exports.fillCalendarGeneralInfo = {
    using: (calendarInfo) => {
        ...
        return core_1.Task.where(`#actor fill calendar general information`, EditCalendarFields_1.calendar.fillTextInputField('Calendar Name', calendarInfo.rowsHash().CalendarName + timeStamp), EditCalendarFields_1.calendar.setCookie(statics_1.COOKIE_CALENDAR_NAME, calendarInfo.rowsHash().CalendarName + timeStamp), EditCalendarFields_1.calendar.fillTextInputField('Standard Working Hours', calendarInfo.rowsHash().StandardWorkingHours));
    }
};
